...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>JSON-java/JSONString.java at master · douglascrockford/JSON-java</title>
...
<meta content="E1kaKGDTOxrLALCQweaZayf+NOVkVyu2YUPBzJZfYcexsWzwFui58k7DIpgy6Yn8YI/OCaTJuqTqIl1WY61r0g==" name="csrf-token" />
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="UlqLUaAC7XrS18TzkbljKjq/kwvxRE4u4k/UbsAgBLGY+y1IYvVHO1k5uLMRVPjZ1Mr9a9tprSSCTb9XCu8s7g==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1187853" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/douglascrockford/JSON-java/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="CRQN2NEBAO2VYTHKt8if1mWG0DWyRujHHFZJDXe0Vv1ReD2nUR7jN+LwrBMBuJgjQb34LSImPF0kpws5Dn2Hrg==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/douglascrockford/JSON-java/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="NP0NsosGN9V2EzEPlQaN5OdvkoUdGdrnohNK+5XMd9L2lu8uJUmhtkYRDMO/czKK0nnAbaULgJANAV0AYMRRWA==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/douglascrockford/JSON-java/blob/8114b976ce7224ff3b89f3d7e53f4207b7dcdf4f/JSONString.java" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:4f5333fdd791f20cd8375a2896926d44 -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/douglascrockford/JSON-java/blob/master/JSONString.java"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
  ...
  <div class="button-group right">
    ...
    <button class="js-zeroclipboard minibutton zeroclipboard-button"
          data-clipboard-text="JSONString.java"
  ...
  <div class="commit file-history-tease">
    ...
    <time class="js-relative-date" data-title-format="YYYY-MM-DD HH:mm:ss" datetime="2012-11-13T14:56:55-08:00" title="2012-11-14 04:26:55">November 13, 2012</time>
    <div class="commit-title">
        <a href="/douglascrockford/JSON-java/commit/dd38c4181dcfadc7ee0db70757ccdcb5eca52a9f" class="message" data-pjax="true" title="whitespace">whitespace</a>
    </div>

    <div class="participation">
      <p class="quickstat"><a href="#blob_contributors_box" rel="facebox"><strong>2</strong>  contributors</a></p>
          <a class="avatar tooltipped tooltipped-s" aria-label="douglascrockford" href="/douglascrockford/JSON-java/commits/master/JSONString.java?author=douglascrockford"><img alt="Douglas Crockford" class=" js-avatar" data-user="262641" height="20" src="https://avatars3.githubusercontent.com/u/262641?s=140" width="20" /></a>
    <a class="avatar tooltipped tooltipped-s" aria-label="ajayk" href="/douglascrockford/JSON-java/commits/master/JSONString.java?author=ajayk"><img alt="Ajay Kemparaj" class=" js-avatar" data-user="1015125" height="20" src="https://avatars2.githubusercontent.com/u/1015125?s=140" width="20" /></a>
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped tooltipped-w"
               href="github-windows://openRepo/https://github.com/douglascrockford/JSON-java?branch=master&amp;filepath=JSONString.java" aria-label="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton tooltipped tooltipped-n js-update-url-with-hash"
                   aria-label="Clicking this button will automatically fork this project so you can edit the file"
                   href="/douglascrockford/JSON-java/edit/master/JSONString.java"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/douglascrockford/JSON-java/raw/master/JSONString.java" class="minibutton " id="raw-url">Raw</a>
            <a href="/douglascrockford/JSON-java/blame/master/JSONString.java" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/douglascrockford/JSON-java/commits/master/JSONString.java" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon tooltipped tooltipped-s"
               href="/douglascrockford/JSON-java/delete/master/JSONString.java"
...
<span id="L18" rel="#L18">18</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">org</span><span class="o">.</span><span class="na">json</span><span class="o">;</span></div><div class='line' id='LC2'><span class="cm">/**</span></div><div class='line' id='LC3'><span class="cm"> * The &lt;code&gt;JSONString&lt;/code&gt; interface allows a &lt;code&gt;toJSONString()&lt;/code&gt;</span></div><div class='line' id='LC4'><span class="cm"> * method so that a class can change the behavior of</span></div><div class='line' id='LC5'><span class="cm"> * &lt;code&gt;JSONObject.toString()&lt;/code&gt;, &lt;code&gt;JSONArray.toString()&lt;/code&gt;,</span></div><div class='line' id='LC6'><span class="cm"> * and &lt;code&gt;JSONWriter.value(&lt;/code&gt;Object&lt;code&gt;)&lt;/code&gt;. The</span></div><div class='line' id='LC7'><span class="cm"> * &lt;code&gt;toJSONString&lt;/code&gt; method will be used instead of the default behavior</span></div><div class='line' id='LC8'><span class="cm"> * of using the Object&#39;s &lt;code&gt;toString()&lt;/code&gt; method and quoting the result.</span></div><div class='line' id='LC9'><span class="cm"> */</span></div><div class='line' id='LC10'><span class="kd">public</span> <span class="kd">interface</span> <span class="nc">JSONString</span> <span class="o">{</span></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="cm">/**</span></div><div class='line' id='LC12'><span class="cm">     * The &lt;code&gt;toJSONString&lt;/code&gt; method allows a class to produce its own JSON</span></div><div class='line' id='LC13'><span class="cm">     * serialization.</span></div><div class='line' id='LC14'><span class="cm">     *</span></div><div class='line' id='LC15'><span class="cm">     * @return A strictly syntactically correct JSON text.</span></div><div class='line' id='LC16'><span class="cm">     */</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">public</span> <span class="n">String</span> <span class="nf">toJSONString</span><span class="o">();</span></div><div class='line' id='LC18'><span class="o">}</span></div></pre></div></td>
         </tr>
       </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04928s from github-fe136-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
